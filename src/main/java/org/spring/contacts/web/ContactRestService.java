package org.spring.contacts.web;
...
public class ContactRestService {
	...
	/*
	@RequestMapping(value="/contac/{id}", method=RequestMethod.PUT)
	public boolean save(@PathVariable Long id,@RequestBody String nom ){
		
		contactRepository.update(nom, id);
	...
	*/
	...
	@RequestMapping(value="/contactb/{id}", method=RequestMethod.PUT)
	public void update(@PathVariable(value = "id", required = true) Long id,
			@RequestBody String nom
			) throws IOException{
		
		contactRepository.update(id, nom);
			}
